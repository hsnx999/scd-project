...
<body>
    ...
    <div class="full-height">
        ...
        <table border="0">
            ...
            <tr>
                <td  colspan="3">
                    <p class="sub-text2">Feeling under the weather today? No need to fret. With eDoc, <br>you can easily connect with healthcare professionals and schedule appointments online.</p>
                </td>
            </tr>
            <tr>
        ...
        <p class="sub-text2 footer-hs">Designed by Hassan Muhammad Sharif, Nimra Shaukat & Mohtashim Zahra.</p>
